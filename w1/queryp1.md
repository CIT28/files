...
- **COMMIT MESSAGE - "folder and file setup"**
## Timemark 0:00 to 12:25:
- Watch and take notes using [markdown](https://www.markdownguide.org/cheat-sheet/) in the README.md file,  that will help you better understand the material covered (like questions) then at timemark 4:13 stop and answer the question asked, then commit with message:
