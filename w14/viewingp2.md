...
- Now code along and create a temporary view and once you are done, output the .schema and the query to pow2.txt. 
...
- Start back and add a sub heading for Triggers with Views and subheading under that for Soft Delete and take a few notes to review the concepts.
...
4. Did you create the pow2.txt include all the required output = 20 points
